...
const _clientEnv = {
  ...
  BASE_API_URL: process.env.IC_BASE_API_URL || 'https://qaapi.resgrid.dev',
  API_VERSION: process.env.IC_API_VERSION || 'v4',
  RESGRID_API_URL: process.env.IC_RESGRID_API_URL || '/api/v4',
  CHANNEL_HUB_NAME: process.env.IC_CHANNEL_HUB_NAME || 'eventingHub',
  REALTIME_GEO_HUB_NAME: process.env.IC_REALTIME_GEO_HUB_NAME || 'geolocationHub',
  CHAT_HUB_NAME: process.env.IC_CHAT_HUB_NAME || 'chatHub',
  LOGGING_KEY: process.env.IC_LOGGING_KEY || '',
  APP_KEY: process.env.IC_APP_KEY || '',
  IS_MOBILE_APP: 'true',
  IC_MAPBOX_PUBKEY: process.env.IC_MAPBOX_PUBKEY || '',
  SENTRY_DSN: process.env.IC_SENTRY_DSN || '',
  COUNTLY_APP_KEY: process.env.IC_COUNTLY_APP_KEY || '',
  COUNTLY_SERVER_URL: process.env.IC_COUNTLY_SERVER_URL || '',
};
