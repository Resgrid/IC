 ...
 *  3. The backend ACS endpoint redirects to ResgridIC://auth/callback?saml_response=<base64>.
...
export function useSamlLogin() {
   ...
   *
   * @param url   The full deep-link URL (e.g. ResgridIC://auth/callback?saml_response=...)
